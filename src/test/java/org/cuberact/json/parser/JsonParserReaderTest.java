...
public class JsonParserReaderTest {
    ...
    public void parseExample1() {
        ...
        Json json = parseJson(jsonAsString);
    ...
    public void parseExample6() {
        String jsonAsString = "[1.1, -1.1, " +
                ...
                "]";
        String expeced = "[1.1,-1.1,2.2E10,2.2E10,-2.2E10,-2.2E-10,2.2E-10,2.2E-10,-2.2E-10,-2.2E-10,1.234512345E12,1.234512345E-4,-1.234512345E12,-1.234512345E-4]";
        Json json = parseJson(jsonAsString);
        assertEquals(expeced, json.toString(JsonFormatter.PACKED()));
    }
    ...
    private Json parseJson(String jsonAsString) {
