...
public class JsonNumberConverterIntFloatTest {
    ...
    public void floatTest() {
        ...
        Number converted = JsonNumberConverterIntFloat.REF.convert(jsonNumber);

        Assert.assertEquals(Float.class, converted.getClass());
    ...
    public void intTest() {
        ...
        Assert.assertEquals(Integer.class, converted.getClass());
